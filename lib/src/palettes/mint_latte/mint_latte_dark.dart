...
const Color _surfaceColor = Color(0xFF101817);
const Color _textColor = Color(0xFFF5F8F7);
const Color _outlineColor = Color(0xFF7A8C88);
const Color _outlineVariantColor = Color(0xFF3D514C);
const Color _errorColor = Color(0xFFF2B8B5);

ColorScheme mintLatteDarkScheme() {
