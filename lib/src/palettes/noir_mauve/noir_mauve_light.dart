...
const Color _surfaceColor = Color(0xFFFDF3FD);
const Color _textColor = Color(0xFF201423);
const Color _outlineColor = Color(0xFF8D7B90);
const Color _outlineVariantColor = Color(0xFFE0CFE2);
const Color _errorColor = Color(0xFFB3261E);

ColorScheme noirMauveLightScheme() {
